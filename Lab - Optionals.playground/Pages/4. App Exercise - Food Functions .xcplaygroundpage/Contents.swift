...
func foodEaten(mealTime : String) -> Meal? {
    var mealList : Meal? = nil
    
    if let varMeal = meals[mealTime] {
        mealList = varMeal
    }
...
print(foodEaten(mealTime: "Breakfast")!)
print(foodEaten(mealTime: "Dinner"))
/*:
