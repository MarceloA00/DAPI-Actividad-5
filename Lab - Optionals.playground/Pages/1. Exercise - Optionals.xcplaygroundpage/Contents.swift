...
print(userAge)
//Because the typo prevents it from properly being a Int, so because the Int is optional it uses the nil as an indidcator that the value is not usable.
/*:
